...
public static final String DATABASE_DATE_FIELD = "DATA";
	...
	private static final String SCRIPT_TABLE_DESPESAS = "CREATE TABLE " + TBL_DESPESAS
			...
			+ " INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT ,"
			+ DATABASE_NAME_FIELD + " TEXT NOT NULL ," 
			+ DATABASE_ID_CONTA + " INTEGER NOT NULL, FOREIGN KEY ("+DATABASE_ID_CONTA+") REFERENCES "+TBL_CONTAS+" ("+DATABASE_ID_FIELD+") ON DELETE CASCADE);";
	...
	private static final String SCRIPT_TABLE_PAGAMENTOS = "CREATE TABLE " + TBL_PAGAMENTOS
			...
			+ DATABASE_ID_USUARIO + " INTEGER NOT NULL, FOREIGN KEY ("+DATABASE_ID_USUARIO+") REFERENCES "+TBL_USUARIOS+" ("+DATABASE_ID_FIELD+") ON DELETE CASCADE,"
			+ DATABASE_ID_DESPESA + " INTEGER NOT NULL, FOREIGN KEY ("+DATABASE_ID_DESPESA+") REFERENCES "+TBL_DESPESAS+" ("+DATABASE_ID_FIELD+") ON DELETE CASCADE);";
